...
/* _____________________________________
    ...
    if (pageGradient.length) {
      pageGradient.gradientify({
        gradients: [
           {start: [255, 87, 0], stop: [255, 165, 0]},     // Main brand orange to lighter orange
            {start: [255, 87, 0], stop: [255, 199, 95]},    // Brand orange to warm yellow
            {start: [255, 165, 0], stop: [255, 235, 201]} 
        ],
        fps: 80
      });
    }
